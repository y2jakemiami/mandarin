...
export const HOST = window.API_HOST || '192.168.1.100';
...
export const MODELS = {
    ...
    tutor: {
        ...
        costPerK: 0.002,     // ~$2 за 1K токенов (оценка для Coder-моделей)
    ...
    translator: {
        ...
        costPerK: 0.0005,    // ~$0.5 за 1K токенов
...
export const AI_CONFIG = {
    ...
    apiKey: window.AI_API_KEY || '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'
};

// === 🎙 TTS CONFIG ===
export const TTS_CONFIG = {
    // ⚠️ Проверь, чтобы этот IP совпадал с реальным адресом твоего TTS-сервера!
    serverUrl: window.TTS_SERVER_URL || `http://${HOST}:8001`, 
    voice: 'femaleru' 
};
